...
CREATE TABLE `usuarioejercicio` (
  ...
  KEY `fk_usu_ejer_idx` (`idUsuario`),
  KEY `fk_ejer_ejer_idx` (`idEjercicio`),
  CONSTRAINT `fk_ejer_ejer` FOREIGN KEY (`idEjercicio`) REFERENCES `ejercicio` (`idEjercicio`),
  CONSTRAINT `fk_usu_ejer` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`idUsuario`)
...
-- Dump completed on 2023-10-19 15:42:42
